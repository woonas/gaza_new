                        ...
                        <div class="col-lg-12">	
                            <div class="panel panel-default">
                                <div class="panel-body">
									<form method="post" action="airplaneEditOk">
											<div class="row2 clearfix">
	                                            <div class="col-tenth">기종:</div>
	                                            <div class="col-nine-tenth"><input type="text" name="airplaneName" value="${vo.airplaneName }" readonly></div>
	                                       	</div>
											<div class="row2 clearfix">
	                                            <div class="col-tenth">총좌석수: </div>
	                                            <div class="col-nine-tenth"><input type="text" name="seatMax" value="${vo.seatMax }"></div>
	                                        </div>
